...
const textNodes = [
  ...
  {
    id: 17, // 🇷🇺 Бежать через вагоны (id:17)
    text: "🇷🇺 Когда поезд доехал до предпоследней станции, ты понял, что машинист уже близко. Поезда уже много лет ездят самостоятельно, а машинисты были нужны просто для контроля поезда. Поэтому поезд бы доехал и до конечной станции, куда тебе и нужно, но машинист уже приближался к твоему вагону. Что ты выберешь? Выйти из вагона метро и пройти до вокзала пешком, либо же начнешь бороться с машинистом в надежде задушить его?! (17-й блок)",
    options: [
      {
        text: "Душить машиниста (Текст кнопки №19)",
        nextText: 19,
      },
      {
        text: "Выйти из вагона метро (Текст кнопки №21)",
        nextText: 21,
      },
    ],
