...
const textNodes = [
  ...
  {
    id: 35, // Поехать на электричке дальше
  ...
  {
    id: 93, // Пустить пулю в голову зомби
    text: "Когда вы покончили с зомби, то направились в логово жуликов и воров. Их лагерь находился в яхт-клубе, теперь уже заброшенном. Вообще, это удачное место для базы, так как в таких местах всегда есть запасы пресной воды, дизтопливо и прочее необходимое. В лагере на тот момент было всего 3 человека: двое из них  - это те, кто недавно убежал с места перестрелки, причем один из них спал, а еще один человек - это сторожевой, то есть, тот, кто дежурил на посту. Вам удалось незаметно подкратся к нему и знаками показать, чтобы он сложил оружие и встал к стене. Вы связали его и воткнули ему кляп в рот. Вам удалось это также сделать и с двумя остальными бандитами. Пока вы допрашивали главаря, один из твоих приятелей пошел осмотреть все вокруг, но вдруг в одной из комнат, похожей на склад, объявился зомби. Вероятно, бандиты пытались держать зомби взаперти, чтобы время от времени брать их на привязь и использовать в своих дерзких атаках на выживших людей. В общем, твой приятель был укушен и обращен в зомби. Затем они бросились на бандитов и съели их. Вам пришлось убить всех зомби. Теперь вживых тут остался только ты и лидер пейнтбольщиков. Рядом с яхт-клубом вы нашли трак с цистерной дизтоплива, но у вас появилась идея, где найти и бензин, но в данный момент задача была простая - добраться до своей базы со всем, что вы добыли во время похода. По дороге вы встретили девушку. Что ты выберешь: подобрать ее, либо же испугаться, что она заражена?",
    options: [
      {
        text: "Не брать девушку с собой",
        nextText: 87,
      },
      {
        text: "Взять девушку с собой",
        nextText: 97,
      },
    ],
  ...
  {
    id: 97, // Взять девушку с собой
    text: "Девушка оказалось молодым врачем. В последствие, она стала самым полезным участником коммуны. В один из дней, в вашу коммуну добавился старый ученый. Врач и ученый вместе смогли изобрести вакцину, используя кровь пойманного зомби. Выяснилось, что если вводить небольшую дозу препарата, содержащего кровь зомби, то вакцинированный человек некоторое время болеет, его лихорадит, но в итоге, появляется иммунитет к укусам. Это была именно вакцина, а не лекарство. То есть, если человек заранее не вакцинировался, но его укусили зомби, то уже поздно ставить вакцину. Получается, если вакцинировать всех хороших людей, то укусы будут угрозой только для плохишей. Хорошим людям осталось только объединиться, защититься в своих лагерях, расставить ловушки для зомби и последних плохишей, а потом начать выстраивать цивилизацию заново. В целом, все налаживалось, но тактические шаги были непростыми. Допустим, чтобы пополнять запасы еды и полезных вещей, приходилось обходить все здания поочередно, включая жилые и нежилые помещения. Встречались такие странности, как фитнес-залы, набитые огромными зомби. Получалось так, что апокалипсис застал качков в спортзале, они не смогли оттуда выбраться, так там и остались, пока не пришли мы и не уничтожили их. Проблему с машинами удалось решить отностильно легко. Мы собрали все электро-автомобили, присварили к ним булл-бары, которые в простонародье называли кенгурятниками. Также мы собрали солнечные панели со всех домов, до которых смогли добраться. Теперь у нас была возможность заряжать наш транспорт и обеспечивать энергией все необходимые приборы В общем, все было супер! Не так хорошо, как до апокалипсиса, но все же не так плохо, как могло бы быть :) Постепенно жизнь начала налаживаться. Все нормализовалось и вошло в свое русло. Люди поверили в будущее, а это самое главное.",
    options: [
      {
        text: "Победа",
        nextText: 3,
